...
export default class ClipboardPage extends Component {
    ...
    <
        ...
        onClick = {this.hideViewer} >
            < Header
        className = "header clipboard-title" >
            短文本分享剪贴板
            < /Header>
            < Content
        className = "clipboard-content" >
            < div
        className = "clipboard-textare-holder" >
            < TextArea
        ...
        type = "primary"
        block
        onClick = {this.pasteText} > 粘贴
        ! < /Button>
        < /div>
        < div
        className = "clipboard-result-holder" >
            < strong > 分享记录 < /strong>
            < div
        className = "clipboard-result-list" >
            {historyCards}
            < /div>
            < /div>
            < div
        className = "clipboard-view-holder"
        style = {viewerStyle} >
            < div
    ...
    >
        {
            this.viewHolderEnd.scrollIntoView()
        }
    }
        />
        < CloseCircleOutlined
