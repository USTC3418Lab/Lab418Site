...
export default class DocPage extends Component {
        ...
        render()
        {
            ...
            <
                ...
                className = "doc-content" >
                    < div
                className = "doc-error-div" > 获取常用信息失败 < /div>
                    < /Content>;
            } else {
            ...
            className = "doc" >
                < Header
            className = "header doc-title" > 实验室常用信息汇总 < /Header>
                < Content
            className = "doc-content" >
                {contentElement}
                < /Content>
    ...
    <
        ...
        to = {
        {
            pathname: "/page/doc-update", state
        :
            {
                doc: doc, typeUpdate
            :
    ...
    <
        ReactMarkdown
        className = "doc-card-para" > {doc.paragraph} < /ReactMarkdown>
            < /Card>;
    }
    };
