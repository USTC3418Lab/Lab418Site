...
const path2All = {
    ...
    getPage(index) {
        return this.mapper[pathList[index]]
    },
    getPageByPath(path) {
        return this.mapper[path].page
    },
    getTitle(index) {
        return this.mapper[pathList[index]].title
    },
    getFatherTitle(index) {
        return this.mapper[pathList[index]].fatherTitle
    },
    getIndexByPath(path) {
        return this.mapper[path].menuIndex
    }
};
